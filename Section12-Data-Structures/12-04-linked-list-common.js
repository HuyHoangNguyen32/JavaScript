// 12-03: Setup common methods for linked list
// - getHead()
// - getTail()
// - getSize()
// - findIndexByData()
...
numberLinkedList.printList(); // 1 2 3 4 5
...
console.log('find 2', numberLinkedList.findIndexByData(2));
console.log('find 5', numberLinkedList.findIndexByData(5));
console.log('find 5', numberLinkedList.findIndexByData(7));

console.log(numberLinkedList.findWithCallback((x) => x % 2 === 0));
console.log(numberLinkedList.findWithCallback((x) => x > 3));
